...
doc.add_paragraph(
    "郭振业，贵州大学电子信息专业在读。核心技能为大语言模型（LLM）应用与智能体（Agent）开发："
    "熟悉LangChain/LangGraph多智能体框架、提示工程与工具调用机制，具备检索增强生成（RAG）系统"
    "与自动化工作流的设计实现经验，能够独立完成从需求分析、系统架构设计到原型落地的全流程开发。"
)
doc.add_heading("6.2 团队分工", level=2)
doc.add_paragraph(
    "本项目由郭振业独立完成，承担系统全部模块的设计与实现工作："
)
for task in [
    "科学问题分析与技术方案设计",
    "9个专业化Agent的架构设计与实现",
    "LangGraph工作流编排与状态管理",
    "文献检索、知识抽取、证据链追踪等核心工具开发",
    "Streamlit交互界面开发",
    "方案文档撰写与项目开源维护",
]:
...
doc.add_paragraph(
    "蓝桥杯全国软件和信息技术专业人才大赛 省级二等奖；"
    "统计建模大赛 省级二等奖。"
    "上述竞赛经历锻炼了算法设计与工程实现能力，为LitMat-Agent多智能体系统的开发奠定了基础。"
)
...
hdr[3].text = "优先级"
rows5 = [
    ("1", "团队成员基本信息", "6.1 成员背景", "已完成"),
    ("2", "各成员具体分工与职责", "6.2 团队分工", "已完成"),
    ("3", "团队过往项目经历与获奖情况", "6.3 团队成果", "已完成"),
